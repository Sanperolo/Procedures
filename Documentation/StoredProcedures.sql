...
AS
--ALTHOUGH THE DEPARTMENT AND EVERYTHING RELATED TO IT IS ELIMINATED, THE EMPLOYEES OF A COMPANY CAN NOT DISAPPEAR,
--FOR THIS REASON INSTEAD OF ELIMINATING THEM, WE UPDATE THEM TO NULL
...
AS
--HERE WE USE DE COUNT OF EMPLOYEE TO SHOW HOW MANY EMPLOYEE ARE WORKING ON EACH DEPARTMENT 
SET NOCOUNT ON;
BEGIN
...
AS
SET NOCOUNT ON;
--ITS EXACTLY THE SAME THAT THE PROCEDURE BEFORE BUT WITHOUT CONDITION (WHERE)
BEGIN
...
SET QUOTED_IDENTIFIER ON
GO
--A FUNTION TO COUNT THE EMPLOYEES AND A JOIN TO SHOW ALL OR 1 SPECIFIC DEPT IF WOULB BE NECESSARY
...
/*
Insert into Employee values ('James', 'E', 'James',	188665555, '1927-11-10 00:00:00.000', '450 Stone, Houston',	'M', 55000.00,	NULL, NULL);
Insert into Employee values ('Edison', 'E', 'Lamar', 188665551, '1977-11-10 00:00:00.000', '450 Stone, Houston',	'M', 85800.00,	NULL, NULL);
